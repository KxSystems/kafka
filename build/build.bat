...
echo In particular add the modifications to user_path within this script if librdkafka.redist.1.0.0 is not in QHOME.
echo Default expected location for librdkafka.redist.1.0.0 is QHOME
echo.
:PROMPT
